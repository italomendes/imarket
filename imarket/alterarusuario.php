              ...
              <div class="">
                <div class="col s12 white darken-1">
                  ...
                  <form class="card-panel col s8 offset-s2 z-depth-5" method="POST">
                    ...
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="cep" id="cep" value="<?php echo $usuario->getCep(); ?>">
                    ...
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="data_nasc" id="data_nasc" value="<?php echo $usuario->getData_nasc(); ?>">
                        <label for="data_nasc">Data de Nascimento</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="sexo" id="sexo" value="<?php echo $usuario->getSexo(); ?>">
                ...
                <?php
                  if(isset($_POST['submit'])){
                    ...
                    //}else{
                          ...
                          $usuario->setTelefone($_  POST['telefone']);
                          $dao = new DaoUsuario();
                          $dao->update($usuario);
