  <?php
    ...
    if (isset($_GET['codigo'])) {
      $dao = new daoUsuario();
      $usuario = $dao->getUsuario($_GET['codigo']);
            ...
            <div class="row collection transparent""> 
              <div class="">
                <div class="col s12 white darken-1">
                  <h3 class="center">Deletar usuário</h3>
                  <form class="card-panel col s8 offset-s2 z-depth-5" method="POST">
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="nome" id="nome" value="<?php echo $usuario->getNome(); ?>" disabled>
                        <label for="nome">Nome</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="cpf" id="cpf" value="<?php echo $usuario->getCpf(); ?>" disabled>
                        <label for="cpf">CPF</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="endereco" id="endereco" value="<?php echo $usuario->getEndereco(); ?>" disabled>
                        <label for="endereco">Endereço</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="cep" id="cep" value="<?php echo $usuario->getCep(); ?>" disabled> 
                        <label for="cep">Cep</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="email" id="email" value="<?php echo $usuario->getEmail(); ?>" disabled>
                    ...
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="data_nasc" id="data_nasc" value="<?php echo $usuario->getData_nasc(); ?>" disabled>
                        <label for="data_nasc">Data de Nascimento</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="sexo" id="sexo" value="<?php echo $usuario->getSexo(); ?>" disabled>
                        <label for="sexo">Sexo</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="telefone" id="telefone" value="<?php echo $usuario->getTelefone(); ?>" disabled>
