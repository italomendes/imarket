                 ...
                 <h3 class="center">Produtos</h3>
                  <div class="row">
                    ...
                    <div class="row center">
                      <a href="http://localhost/projetonovo/cadastroproduto.php"><button class="btn waves-effect grey darken-3 center"><i class="material-icons left">add_circle</i>ADICIONAR PRODUTO</button></a>
                    </div>
                </div> 
              </div>
            </div>  
