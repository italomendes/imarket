              ...
              <div class="">
                <div class="col s12 white darken-1">
                  ...
                  <form class="card-panel col s8 offset-s2 z-depth-5" method="POST">
                    ...
                    <!--<div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="data_add" id="data_add" value="<?php echo $produto->getData_add(); ?>">
                        <label for="data_add">Data de adição</label>
                      </div>
                    </div>-->
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="data_val" id="data_val" value="<?php echo $produto->getData_val(); ?>">
                    ...
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="qndt_estoque" id="qndt_estoque" value="<?php echo $produto->getQndt_estoque(); ?>">
                        <label for="qndt_estoque">Quantidade de estoque</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="cod_barras" id="cod_barras" value="<?php echo $produto->getCod_barras(); ?>">
                    ...
                    <div class="row">
                      <div class="col s12 input-field">
                        <input type="text" name="img" id="img" value="<?php echo $produto->getImg(); ?>">
